export const EN = {
    ...
    ui: {
        ...
        parser: {
            ...
            injectionModeExtension: 'Extension prompt (default)',
            injectionModeMacro: 'Macro placeholder',
            macroPlaceholder: 'Macro name',
            macroPlaceholderPh: 'Name only, no braces. e.g. world_engine',
            macroFallback: 'Fallback to extension prompt in macro mode',
            macroHint:
                'In macro mode, place {placeholder} in your prompt. Enable fallback if you may forget it.',
            macroPreview: 'Current placeholder: {placeholder}',
        ...
        cycle: {
            ...
            manualAgePh: 'Age',
            manualAdd: 'Add',
            manualAgeHint: 'You can enter age (e.g. 20) or birth date (e.g. 2004-05-20).',
    ...
    toast: {
        ...
        ageInvalid: 'Age must be a positive integer, or a birth date in YYYY-MM-DD format',

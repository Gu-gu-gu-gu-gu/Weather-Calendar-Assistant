export const ZH = {
    ...
    ui: {
        ...
        parser: {
            ...
            injectionMode: '注入方式',
            injectionModeExtension: '扩展注入（默认）',
            injectionModeMacro: '宏占位符注入',
            macroPlaceholder: '宏名',
            macroPlaceholderPh: '只填名字，不要写花括号，如 world_engine',
            macroFallback: '宏模式保底同步扩展注入',
            macroHint: '宏模式下，请在提示词中写入 {placeholder}。若忘记写入，可开启保底。',
            macroPreview: '当前占位符：{placeholder}',
            tagWrapper: 'XML标签名',
        ...
        cycle: {
            ...
            manualAgePh: '年龄',
            manualAdd: '+添加',
            manualAgeHint: '可填年龄（如 20）或生日（如 2004-05-20）。',
            rescan: '🔄 重新扫描角色',
    ...
    toast: {
        ...
        ageInvalid: '年龄需为正整数，或生日格式 YYYY-MM-DD',
